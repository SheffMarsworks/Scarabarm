...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        ...
        'scarab_ros2/src/scarabarm_ros2/scarabarm_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'scarab_ros2/install/scarabarm_moveit_config/share/scarabarm_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='scarabarm',
    ...
    DeclareLaunchArgument('flange_link', default_value='tool_0',

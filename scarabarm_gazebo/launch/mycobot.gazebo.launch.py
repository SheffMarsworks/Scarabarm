...
def generate_launch_description():
    ...
    package_name_gazebo = 'scarabarm_gazebo'
    package_name_description = 'scarabarm_description'
    package_name_moveit = 'scarabarm_moveit_config'

    default_robot_name = 'scarabarm'
